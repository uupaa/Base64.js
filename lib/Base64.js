...
//{@assert
    _if(!_type(source, "String"), "Base64.btoa(source)");
//}@assert
...
//{@assert
    _if(!_type(source, "String"), "Base64.atob(source)");
//}@assert
...
//{@assert
    _if(!_type(source, "Array"),             "Base64.encode(source)");
    _if(!_type(toURLSafe64, "Boolean/omit"), "Base64.encode(,toURLSafe64)");
//}@assert
...
//{@assert
    _if(!_type(source, "String"), "Base64.decode(source)");
//}@assert
