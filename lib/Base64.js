...
if (_inNode) {
//{@node
    Base64["btoa"]   = Buffer_btoa;    // Base64.btoa(source:String):Base64String
...
//{@dev
    Valid(Valid.type(source, "String"), Base64.btoa, "source");
//}@dev
    ...
    if ("btoa" in global) {
        ...
        return global["btoa"](
                    ByteArray["toString"](
                        ByteArray["fromString"](source) ) ); // low-pass filter
    }
...
//{@dev
    Valid(Valid.type(source, "String"), Base64.atob, "source");
//}@dev
...
function Buffer_encode(source) { // @arg ByteArray [0xff, ...]
                                 ...
                                 // @desc ByteArray to Base64String.
//{@dev
    Valid(Valid.type(source, "Array"), Base64.encode, "source");
//}@dev
...
function Buffer_decode(source) { // @arg Base64String
                                 ...
                                 // @desc Base64String to ByteArray.
//{@dev
    Valid(Valid.type(source, "String"), Base64.decode, "source");
//}@dev
...
//{@dev
    Valid(Valid.type(source, "Array"), Base64.encodeArray, "source");
//}@dev
...
//{@dev
    Valid(Valid.type(source, "Array"), Base64.byteDecode, "source");
//}@dev
...
//{@dev
    Valid(Valid.type(source, "Uint8Array"), Base64.encodeTypedArray, "source");
//}@dev
...
//{@dev
    Valid(Valid.type(source, "Uint8Array"), Base64.decodeTypedArray, "source");
//}@dev
...
//{@dev
    Valid(Valid.type(source, "String"), Base64_toURLSafe64, "source");
//}@dev
...
//{@dev
    Valid(Valid.type(source, "String"), Base64_fromURLSafe64, "source");
//}@dev
