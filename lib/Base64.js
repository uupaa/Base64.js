...
//{@dev
    Valid(Valid.type(source, "BinaryString"), Base64_btoa, "source");
//}@dev
...
//{@dev
    Valid(Valid.type(source, "String"), Base64_atob, "source");
//}@dev
...
//{@dev
    Valid(Valid.type(source, "ByteArray"), Base64_encode, "source");
//}@dev
...
//{@dev
    Valid(Valid.type(source, "Base64String"), Base64_decode, "source");
//}@dev
...
//{@dev
    Valid(Valid.type(source, "ByteArray"), Base64_encodeArray, "source");
//}@dev
...
//{@dev
    Valid(Valid.type(source, "Base64ByteArray"), Base64_decodeArray, "source");
//}@dev
...
//{@dev
    Valid(Valid.type(source, "Uint8Array"), Base64_encodeTypedArray, "source");
//}@dev
...
//{@dev
    Valid(Valid.type(source, "Uint8Array"), Base64_decodeTypedArray, "source");
//}@dev
