...
//}@assert
    ...
    if (global.btoa) {
        ...
        return global.btoa(
                    WordArray.toString(
                        WordArray.fromString(source, true) ) ); // low-pass filter
    }
    return Base64_encode( WordArray.fromString(source, true) ); // low-pass filter
}
...
//}@assert
    ...
    return WordArray.toString( Base64_decode(base64) );
}
