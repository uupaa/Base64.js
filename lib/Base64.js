...
//}@assert
    ...
    if (global.btoa) {
        ...
        return global.btoa( Binary.filter(source, 0xff) );
    }
    return Base64_encode( Binary.BinaryStringToUintArray(source, 0xff) );
}
...
//}@assert
    ...
    return Binary.UintArrayToBinaryString( Base64_decode(base64) );
}
